...
- Redox handwire
  ...
  - [Iris-inspired Redox case](https://github.com/Lenbok/scad-redox-case): a case inspired both by the Redox rev.1.0 and the Iris designed with OpenSCAD by [Lenbok](https://github.com/Lenbok).
- Redox rev1.0
